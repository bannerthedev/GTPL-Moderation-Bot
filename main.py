...
TOKEN = "MTQ4MTg0MzM1NzM1NjM5NjYxNA.GZhhez.7ecfLH2UOIbvZvEtigx4DVBLBXeZqU5UUIcPB0"

# ------------ IDs / CONSTANTS ------------
MAIN_GUILD_ID = 1373047202791948288   # main server ID
APPEAL_GUILD_ID = 1500695212111171685 # appeal server ID
APPEAL_CHANNEL_ID = 1500695650277396511  # appeal review channel ID (in appeal server)
STAFF_ROLE_ID = 1500695704702554304     # staff role in appeal server (ping + permissions)

MAIN_SERVER_INVITE = "https://discord.gg/f8t4d7k2Tq"
SERVER_NAME = "Gorilla Tag Premiere League"
APPEAL_LINK = "https://discord.gg/pauzjWtsq3"  # for ban DM
